...
activities = {
    ...
    "Basketball Club": {
        "description": "Join the basketball team for competitive play and practice",
    ...
    "Drama Club": {
        "description": "Experience acting, stage performance, and theatrical productions",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 25,
        "participants": ["sarah@mergington.edu"]
    },
    "Art Studio": {
        "description": "Create paintings, drawings, and sculpture projects",
